...
var addBorder = document.querySelector(".todos-list")
...
function update() {
  ...
  pendingList = todoList.filter((ele) => {
    return !ele.complete
  })
...
function deleteTodo(e) {
  ...
  if (todoList.length == 0) {
    addBorder.classList.remove("add");
  }
